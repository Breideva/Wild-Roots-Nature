...
function Body() {
  return (
    <div className="z-20 relative">
      ...
      <div className=" justify-center items-center flex flex-col text-center m-10 mx-40 p-10 bg-bgBox shadow-md">
        <h2 className="text-6xl font-semibold">Help Make A Contribution</h2>
        <div className="flex text-2xl justify-center">
          <p className="w-1/3 p-5">
        ...
        <div className="flex flex-col justify-center items-center p-8 bg-bgBox2 w-fit">
          <h2 className="mx-2 text-4xl font-medium">
          ...
          <button className="mt-4 text-xl p-2 rounded-xl font-semibold bg-bgBlue text-white hover:bg-blue-700">
            Take Action
          </button>
        </div>
      </div>
